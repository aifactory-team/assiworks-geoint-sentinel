# 최신 위성 인사이트 — 설악산 국립공원 (산림)

**발행**: 2026-06-14 21시 · **분야**: 산림 · **센서**: Sentinel-2 L2A (ESA) · 10 m
**원본 촬영**: 2026-05-31 (구름 7.6%, 신규 위성영상)
...
- 평균 NDVI(식생활력): 약 0.872.
- 산림 식생활력(NDVI) 평균 약 0.872
- 저활력·나지·고사 의심 약 0.2%

## 2단계 — 시계열 검증
동일 지역 과거 청천 영상(2개)과 비교해 검증합니다.
- 과거: 05-18 0.831, 06-12 0.839
- 현재: 05-31 약 0.872
